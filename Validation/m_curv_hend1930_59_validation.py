...
def get_moment_curvature(axial_load=0, max_curve=0.15, num_incr=100):
    ...
    rebar = o3.uniaxial_material.Steel01(osi, fy=fy, e0=Es, b=0) #Steel reinforcing properties
...
if __name__ == '__main__':
    ...
    mom, curve ,mom_crack, mom_yield = get_moment_curvature(num_incr=4000, max_curve=0.1)
    ...
    np.savetxt('m_curv_opensees_vTEST.csv', (mom_list, curve_list), fmt='%.4e', delimiter=',')# X is an array
