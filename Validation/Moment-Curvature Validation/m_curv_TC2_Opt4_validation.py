...
def get_moment_curvature(axial_load=0, max_curve=0.25, num_incr=100):
    ...
    Dh = 0.01 #diameter of transverse reinforcement (m)
...
if __name__ == '__main__':
    ...
    np.savetxt('m_curv_opensees_vTEST_TC2_Opt4.csv', (mom_list, curve_list), fmt='%.4e', delimiter=',')# X is an array

    fpc = 30.0e6  # Conc compressive strength (Pa)
    Ec = 5000 * (fpc ** 0.5) * 1E3
    d = 0.385  # section depth (m)
