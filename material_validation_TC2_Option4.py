...
def create():
    ...
    fpc = 30.0 #Conc compressive strength (MPa) assume 30 MPa for TC2 options.... henderson is 17.2 MPa
    ...
    Ast = 452.4 #Total area of longtitudinal steel [mm^2]
    Dh = 10 #diameter of transverse reinforcement (mm)
    clb = 50 #cover to longtitudinal bars (mm)
    ...
    ax[0].legend(bbox_to_anchor=(0, 1.02,0.5, 0.5), loc='upper left', borderaxespad=0)
