...
def get_moment_curvature(axial_load=0, max_curve=0.001, num_incr=500):
    ...
    fc = 2.538 #concrete compressive strength
    #e_mod = 57000.0 * np.sqrt(fc * 1000.0) / 1e3 #Is not used in analysis at the moment - Should be??...

    conc_conf = o3.uniaxial_material.Concrete01(osi, fpc=-fc, epsc0=-0.005, fpcu=-0.003, eps_u=-0.02) #Confined concrete paramters
    conc_unconf = o3.uniaxial_material.Concrete01(osi, fpc=-fc, epsc0=-0.002, fpcu=-0.003, eps_u=-0.006) #Unconfined concrete parameters
