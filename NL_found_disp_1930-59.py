...
def get_moment_curvature(axial_load, max_curve, num_incr):
    ...
    n_bars = 2
    bar_area = 113.097335 #[mm^2] area of one 12mm diameter reinforcing bar
...
#layer command generates a row of fibers along a geometric-arc, in a straight line
  #layer command generates a row of fibers along a geometric-arc, in a straight line
    ...
    print(moment)
    print(curvature)
    return moment, curvature, d, b, Ec



if __name__ == '__main__':

    mom, curve, d, b, Ec = get_moment_curvature(axial_load=0,max_curve=0.003,num_incr=500)
...
def run(lf=10, dx=0.5, xd=(3,7), yd=(-1,-1), ksoil=2.5e3, udl=0.03e3, axial_load=0, max_curve=0.003, num_incr=500):
    """
    ...
    :return:
    """
    moment, curvature, d, b, Ec = get_moment_curvature(axial_load, max_curve, num_incr)
    print(moment)
    print(curvature)
    print(d)
    print(b)
