...
def run(lf=10, dx=0.5, xd=(3,7), yd=(-1,-2), ksoil=2.5e3, udl=0.03e3, axial_load=0, max_curve=0.003, num_incr=500):
    """
    ...
    for i in range(len(nx)):
        ...
        if i != 0:
            ...
            bot_sect = (osi, conc_conf, conc_unconf, rebar, nf_core_y, nf_core_z, nf_cover_y, nf_cover_z)
