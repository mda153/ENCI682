...
name = '1930_59_henderson_data_vf'; %identifies actual work, the output file will be name.xls
...
H    = 600;                                % section height (mm)- perp to x
B    = 150;                              % section width  (mm)- perp to y
ncx  = 2;                                 % # legs transv. steel x_dir (confinement)
ncy  = 2;                                 % # legs transv. steel y_dir (shear)
clb  = 44;                                % cover to longitudinal bars (mm)

% member properties

L       = 1000;                       % member clear length (mm)
...
Dh      = 6;                                   % diameter of transverse reinf. (mm)
s       = 600;                                  % spacing of transverse steel (mm)*

% applieed loads:

P      = 0;               % axial load kN (-) tension (+)compression
...
wi   = [0]; % vector with clear distances between
...
fpc     = 17.2;            % concrete compressive strength (MPa)
...
esm     = 0.125;               % max transv. steel strain (usually ~0.10-0.15)*
espall  = 0.0064;            % max uncon. conc. strain (usually 0.0064)

fy      = 300;               % long steel yielding stress (MPa)
fyh     = 300;               % transverse steel yielding stress (MPa)
Es      = 200000;            % steel modulus of elasticity
fsu     = 450;               % long steel max stress (MPa)*
esh     = 0.008;             % long steel strain for strain hardening (usually 0.008)*
esu     = 0.125;              % long. steel maximum strain (usually ~0.10-0.15)*

Ey     =  450;                % slope of the yield plateau (MPa)
C1     =  2;                % defines strain hardening curve in the Raynor model [2-6]
...
ecser = 0.003;    esser = 0.015;   % concrete (ecser) and steel (esser) serviceability strain
ecdam = 0.015 ; esdam = 0.060;     % concrete (ecser) and steel (esser) damage control strain
