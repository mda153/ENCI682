...
name = 'TC2_option4_vf'; %identifies actual work, the output file will be name.xls
...
H    = 385;                                % section height (mm)- perp to x
...
Dh      = 10;                                   % diameter of transverse reinf. (mm)
s       = 300;                                  % spacing of transverse steel (mm)*
