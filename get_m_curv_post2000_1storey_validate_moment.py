...
def get_moment_curvature(axial_load=0, max_curve=0.001, num_incr=500):
    ...
    conc_conf = o3.uniaxial_material.Concrete01(osi, fpc=-2.538, epsc0=-0.005, fpcu=-3.5, eps_u=-0.02) #Confined concrete paramters
    ...
    moment = -nm.collect()
    return moment, curvature, -mr.collect()


if __name__ == '__main__':
    import matplotlib.pyplot as plt

    mom, curve, m2 = get_moment_curvature()
    bf, ax = plt.subplots()
    ax.plot(curve, mom)

    ax.plot(curve, m2[:, 2], ls='--')
